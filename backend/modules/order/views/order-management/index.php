...
<a class='btn btn-default btnViewDelete' href='<?= Url::to(['/order/order-management/view-delete'])?>'>ดูคำร้องที่ถูกลบ <i class="fa fa-arrow-right" aria-hidden="true"></i>
</a>
</div>
...
//                    return appxq\sdii\utils\SDdate::mysql2phpDate($model->create_date);
           ...
           [
                ...
                'value'=>function($model){
                    ...
                    $items = ['1'=>'รอพิจารณา' , '2'=>'ส่งข้อมูลแล้ว', '3'=>'ไม่อนุมัติ', '100'=>''];
                ...
                'filter'=>['1'=>'รอพิจารณา' , '2'=>'ส่งข้อมูลแล้ว', '3'=>'ไม่อนุมัติ', '100'=>''],        
            ], 
        [
            'format' => 'raw',
        ...
        [
            ...
            'value' => function($model) {
                if(isset($model->send_date)){
                          return \appxq\sdii\utils\SDdate::mysql2phpDate($model->send_date);
                        // return $model->send_date; //appxq\sdii\utils\SDdate::mysql2phpThDateTime($model->send_date);
                }
                return '';
            },
             'filter' => \yii\jui\DatePicker::widget([
        ...
        [
                        ...
                        'contentOptions' => ['style'=>'width:300px;text-align: center;'],
                         'template' => '{confirm} {print} {download} {delete} ',
                        ...
                        'buttons' => [
                            ...
                            'print' => function ($url, $model) {
                                $label = Yii::t('section', 'ปริ้นคำร้อง');
