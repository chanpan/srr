...
<div class="container text-center" style="margin-bottom:10px;">
    ...
    <a target="_blank" download data-id="<?= $id?>" href="<?= \yii\helpers\Url::to(['/order/order-management/download'])?>" class="btn btn-primary btnDownload"><i class="fa fa-download" aria-hidden="true"></i> ดาวน์โหลด</a>
</div>
